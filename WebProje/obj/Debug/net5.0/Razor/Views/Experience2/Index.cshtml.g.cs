#pragma checksum "C:\Users\HuseyinCan\source\repos\WebProje\WebProje\Views\Experience2\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "dbe31d4b14a8f6c155161e9b2f83f07362b87b42133dc83c65bf9a22dc65a0f5"
// <auto-generated/>
...
#nullable disable
    ;
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"dbe31d4b14a8f6c155161e9b2f83f07362b87b42133dc83c65bf9a22dc65a0f5", @"/Views/Experience2/Index.cshtml")]
...
#nullable disable
	...
	<div class=""col-md-6"">
		<div class=""p-2"">
			...
			<button type=""button"" id=""update"" class=""btn btn-outline-danger"">Güncelle</button>
		</div>
	</div>
	...
	<div class=""col-md-12"">
		...
		<input type=""text"" class=""form-control"" id=""inpid"" p");
            WriteLiteral("laceholder=\"ID giriniz\" />\r\n\t\t<br />\r\n\t</div>\r\n\r\n\t<div class=\"col-md-12\">\r\n\t\t<h4>Id\'ye Göre Sil</h4>\r\n\t\t<input type=\"text\" class=\"form-control\" id=\"inpdelid\" placeholder=\"ID giriniz\" />\r\n\t\t<br />\r\n\t</div>\r\n\r\n");
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n\t\t");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dbe31d4b14a8f6c155161e9b2f83f07362b87b42133dc83c65bf9a22dc65a0f55546", async() => {
                }
                );
		...
		<script>
			...
			$(""#getbyID"").click(function () {
				...
				$.ajax({
					...
					success: function (funk2) {
						...
						console.log(result)
						let htmlst = `<table class=table table-hover>   <tr>  <th># </th> <td> ${result.experienceID} </td> </tr> <tr>  <th>İsim</th> <td> ${result.name} </td> </tr> <tr>  <th>Tarih</th> <td> ${result.date} </td> </tr>`
						htmlst += ""</table>""
			...
			$(""#delete"").click(function () {
				...
				$.ajax({
					...
					type: ""GET"",
");
                WriteLiteral("\t\t\t\t\turl: \"/Experience2/DeleteExperience/\" + id,\r\n\t\t\t\t\tsuccess: function (funk3) {\r\n\t\t\t\t\t\tlet val = funk3\r\n\t\t\t\t\t\talert(val + \"başarıyla silindi\")\r\n\t\t\t\t\t}\r\n\t\t\t\t});\r\n\r\n\t\t\t});\r\n\t\t</script>\r\n\t");
            }
            );
            WriteLiteral("\r\n\r\n");
        }
